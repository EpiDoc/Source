                    ...
                    <xsl:element name="div">
                        ...
                        <xsl:for-each select="tei:teiHeader/tei:fileDesc/tei:publicationStmt">
                            <xsl:element name="p">
                                ...
                                <xsl:choose>
                                    <xsl:when test="tei:idno[@type='release'] = '&#x24;Name&#x24;' or tei:idno[@type='release'] = '&#x24;Name:  &#x24;' or tei:idno[@type='release'] = '&#x24;Name: HEAD &#x24;'">This version is a development snapshot.</xsl:when>
