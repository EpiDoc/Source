...
Current dtd version shipped here (FOR *GUIDELINES* DEVELOPMENT USE ONLY) is derived from Rev 1.12 in the dtd module in sourceforge cvs, with changes:
