...
public class Tester extends javax.swing.JFrame {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jMenuFont.setRolloverEnabled(true);
        jMenuFont.setAutoscrolls(true);
        jMenuEncodings.add(jMenuFont);
    ...
    private class FontMenuItem extends javax.swing.JMenuItem {
        ...
        private void itemSelected(java.awt.event.ActionEvent evt) {
            ...
            this.select();
            conversionArea.setFont(new Font(this.getText(), Font.PLAIN, 12));
        }
